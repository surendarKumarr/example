...
export class AmazonHands extends BaseHands{
    ...
    searchMobile(){
        ...
        cy.get('.celwidget > div.rush-component > .s-expand-height > .a-spacing-medium > :nth-child(2) > :nth-child(1) > .sg-col-inner > .a-spacing-none > .rush-component > .a-link-normal > .a-section').trigger('mousedown')    
